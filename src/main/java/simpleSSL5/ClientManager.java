...
public class ClientManager  implements TokenServiceHttpClient,Observable<TokenChangeObserver<MyToken>>{
	...
	public  <T extends AccessToken> ClientManager(Class<T> tokenClass) {
